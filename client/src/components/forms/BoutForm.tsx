...
import { FormTextElement } from './form_elements/FormTextElement';
import { FormNumberElement } from './form_elements/FormNumberElement';
import { FormRatingElement } from './form_elements/FormRatingElement';
import { FormSelectElement } from './form_elements/FormSelectElement';
import { FormCheckBoxElement } from './form_elements/FormCheckBoxElement';
import { DialogBox } from '../DialogBox';
import { HAND_CHOICES, SHAREABLE_CHOICES } from '../../constants/VarOptions';
import { fencerListType } from '../../constants/VarTypes';
import { CSRF } from './form_elements/CSRF';
    ...
    return (
      <section className="bout-tab-content">
        ...
        <FormSelectElement
          setValue={setFencerA}
          placeholder=""
          elementName="fencer-a"
          labelText="Select Fencer"
          selectOptions={fencerOptions}
        />
        <FormNumberElement
          setValue={setScoreA}
          elementName="score-a"
        ...
        />
        <FormSelectElement
          setValue={setFencerAHand}
          placeholder=""
          elementName="fencer-a-hand"
          labelText="Select Hand"
          selectOptions={HAND_CHOICES}
        />
        <FormNumberElement
          setValue={setFencerAVideoUsed}
          elementName="fencer-a-video-used"
          labelText="Fencer A Video Used"
        />
        <FormCheckBoxElement
          setValue={setFencerAMedical}
          labelText="Fencer A Medical Timeout"
        />
        <FormTextElement
          setValue={setFencerANotes}
          elementName="fencer-a-notes"
          placeholder=""
          labelText="Fencer A Notes"
        />

        <h2>Cards:</h2>
        <FormCheckBoxElement
          setValue={setFencerAYellowCard}
          labelText="Fencer A Yellow Card"
        />
        <FormCheckBoxElement
          setValue={setFencerARedCard}
          labelText="Fencer A Red Card"
        />
        <FormCheckBoxElement
          setValue={setFencerABlackCard}
          labelText="Fencer A Black Card"
        />
        <FormCheckBoxElement
          setValue={setFencerAPassivity}
          labelText="Fencer A Passivity"
        />

        <h2>Fencer Ratings:</h2>
        <FormRatingElement
          setValue={setFencerAFootwork}
          labelText="Fencer A Footwork"
        />
        <FormRatingElement
          setValue={setFencerABladework}
          labelText="Fencer A Bladework"
        />
        <FormRatingElement
          setValue={setFencerATiming}
          labelText="Fencer A Timing"
        />
        <FormRatingElement
          setValue={setFencerADistance}
          labelText="Fencer A Distance"
        />
        <FormRatingElement
          setValue={setFencerAEnergy}
          labelText="Fencer A Energy"
        />
      </section>
    );
  }
  ...
  function fencerBDetail() {
    return (
      <section className="bout-tab-content">
        ...
        />
        <FormSelectElement
          setValue={setFencerBHand}
          placeholder=""
          elementName="fencer-b-hand"
          labelText="Select Hand"
          selectOptions={HAND_CHOICES}
        />
        <FormNumberElement
          setValue={setFencerBVideoUsed}
          elementName="fencer-b-video-used"
          labelText="Fencer B Video Used"
        />
        <FormCheckBoxElement
          setValue={setFencerBMedical}
          labelText="Fencer B Medical Timeout"
        />
        <FormTextElement
          setValue={setFencerBNotes}
          elementName="fencer-b-notes"
          placeholder=""
          labelText="Fencer B Notes"
        />

        <h2>Cards:</h2>
        <FormCheckBoxElement
          setValue={setFencerBYellowCard}
          labelText="Fencer B Yellow Card"
        />
        <FormCheckBoxElement
          setValue={setFencerBRedCard}
          labelText="Fencer B Red Card"
        />
        <FormCheckBoxElement
          setValue={setFencerBBlackCard}
          labelText="Fencer B Black Card"
        />
        <FormCheckBoxElement
          setValue={setFencerBPassivity}
          labelText="Fencer B Passivity"
        />

        <h2>Fencer Ratings:</h2>
        <FormRatingElement
          setValue={setFencerBFootwork}
          labelText="Fencer B Footwork"
        />
        <FormRatingElement
          setValue={setFencerBBladework}
          labelText="Fencer B Bladework"
        />
        <FormRatingElement
          setValue={setFencerBTiming}
          labelText="Fencer B Timing"
        />
        <FormRatingElement
          setValue={setFencerBDistance}
          labelText="Fencer B Distance"
        />
        <FormRatingElement
          setValue={setFencerBEnergy}
          labelText="Fencer B Energy"
        />
      </section>
    );
  }
  ...
  function boutOverallDetail() {
    return (
      <section className="bout-tab-content">
        ...
        />
        <FormSelectElement
          setValue={setBoutFormat}
          placeholder=""
          elementName="bout-format"
          labelText="Bout Format"
          selectOptions={HAND_CHOICES}
        />
        <FormTextElement
          setValue={setReferee}
        ...
        />
        <FormTextElement
          setValue={setBoutNotes}
          elementName="bout-notes"
          placeholder=""
          labelText="Overall Notes"
        />
        <FormSelectElement
          setValue={setShareable}
          placeholder=""
          elementName="shareable"
          labelText="Shareable"
          selectOptions={SHAREABLE_CHOICES}
        />
      </section>
    );
  }
